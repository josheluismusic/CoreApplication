...
using CoreApplication.Common.Instrumentation.Configuration;
using CoreApplication.Common.Instrumentation.Counter;
using CoreApplication.Common;

namespace CoreApplication.Common.Instrumentation
{
    /// <summary>
