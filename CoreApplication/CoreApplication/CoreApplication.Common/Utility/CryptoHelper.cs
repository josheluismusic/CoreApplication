...
namespace CoreApplication.Common.Utility
{
            ...
            get
            {
                if (String.IsNullOrEmpty(_key))
                {
                    ...
                    if (String.IsNullOrEmpty(key))
                        key = _defaultKey;
                        //throw new NucleoCommonException("No es posible iniciar la criptogrfía ya no se pudo obtener la clave de encriptación. Verifique la sección <machineKey/> del archivo de configuración.");
